        ...
        <MasterPage pageTitle="Login">
            <div id="auth-container" className="w-full h-[100dvh]">
                <div className="flex flex-col items-center justify-center w-full h-full bg-black/50">
                    <div className="bg-white p-6 px-8 w-full h-full flex items-center justify-center sm:block sm:w-max sm:h-max">
                        <div className="sm:w-[300px] max-w-full">
                            ...
                            <button className="w-full text-center px-4 py-3 mt-2 bg-primary hover:bg-primary-hover transition-all text-white">Log In</button>
                        </div>
                    </div>
                </div>
            </div>
